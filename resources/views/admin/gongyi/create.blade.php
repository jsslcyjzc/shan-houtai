...
<div class="tpl-portlet-components">
    <div class="portlet-title">
        <div class="caption font-green bold">
            <span class="am-icon-code"></span>公益基金添加
        </div>
    ...
    <div class="tpl-block">
        <div class="am-g">        	
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" action="/gongyis" method="post" enctype="multipart/form-data">
                   ...
                   <div class="am-form-group">
                      ...
                      <div class="am-form-group">
                        <label for="user-email" class="am-u-sm-3 am-form-label">公益图片</label>
                        <div class="am-form-group am-form-file">
                            ...
                            <input id="doc-form-file" type="file" multiple="" name="images" id="xdaTanFileImg" onchange="xmTanUploadImg(this)" accept="image/*"/>
