        ...
        <div class="tpl-block">
            ...
            <div class="am-g">
                <div class="tpl-form-body tpl-form-line">
                    <form class="am-form tpl-form-line-form" method="post" action="/banner/{{ $banner->bid }}" enctype="multipart/form-data">
                        <div class="am-form-group">
                            <label for="user-name" class="am-u-sm-3 am-form-label">Banner 名称 <span class="tpl-form-line-small-title">/ name</span></label>
                            <div class="am-u-sm-9">
                                <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入Banner 名称文字" name="bname" value="{{ $banner->bname }}">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" placeholder="输入Banner 链接" name="blink" value="{{ $banner->blink }}">
                            ...
                            <div class="am-u-sm-9">
                                <div class="am-form-group am-form-file">
                                    <div class="tpl-form-file-img">
                                        <img id="xmTanImg"/ src="{{ $banner->pic }}">
                                        <div id="xmTanDiv"></div>
