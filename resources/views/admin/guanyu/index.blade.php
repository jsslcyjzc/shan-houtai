    ...
    <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 关于我们列表
                    </div>
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title" style="width: 100px;">标题</th>
                                            <th class="table-time" style="width: 80px;">时间</th>
                                            <th class="table-time" style="width: 200px;">内容</th>
                                            <th class="table-status" style="width: 50px;">状态</th>
                                            ...
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs" style="margin-top: 7px;">
                                                       <a href="/guanyu/{{$v->id}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary bj" type="submit" style="font-size: 15px; width: 80px;height: 30px;line-height: 10px;">
                                                        	<span class="am-icon-pencil-square-o"></span> 修改
                                                        
                                                       </a>
                                                         <form class="del" action="/guanyu/{{$v->id}}" method="post" style="float: left;">
                                                            {{method_field('DELETE')}}
                                                            {{csrf_field()}}
