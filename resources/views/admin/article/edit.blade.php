                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            ...
                            <form class="am-form am-form-horizontal" action="/article/{{$article->id}}" role="form" method="post" enctype="multipart/form-data">
                                ...
                                <div class="am-form-group">
                                    <label for="user-pic" class="am-u-sm-3 am-form-label">照片</label>
                                    <div class="am-u-sm-9">
                                        <img src="{{$article->pic}}" width="240">
                                        <input type="file" id="user-pic" class="am-input-sm" name="pic">
                                    </div>
                                </div>

                                  <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">文章内容</label>
                                    <script id="editor" type="text/plain" name="content" style="width:800px;height:500px;margin-top:50px;margin-left: 100px;"></script>
                                </div>
